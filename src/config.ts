...
export const siteConfig: SiteConfig = {
	title: "Kaftta",
	subtitle: "A website",
	siteURL: "https://kaftak.xyz/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-04-12", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	themeColor: {
		hue: 125, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	bangumi: {
		userId: "zxsa71", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	...
	banner: {
		...
		homeText: {
			...
			title: "Kaftta's Channel", // 主页横幅主标题
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/zxsa71/mizuki",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/5430720",
					external: true,
